...
date_start = '2018-03-01 01:04:10.000';
...
[~,mms1_mec_r_gsedata_interp] = interpxyz(mms1_mec_timedata_raw,mms1_mec_r_gsedata_raw,mms1_fgm_timedata_raw);
[~,mms2_fgm_bdata_interp] = interpxyz(mms2_fgm_timedata_raw,mms2_fgm_bdata_raw,mms1_fgm_timedata_raw);
[~,mms2_mec_r_gsedata_interp] = interpxyz(mms2_mec_timedata_raw,mms2_mec_r_gsedata_raw,mms1_fgm_timedata_raw);
[~,mms3_fgm_bdata_interp] = interpxyz(mms3_fgm_timedata_raw,mms3_fgm_bdata_raw,mms1_fgm_timedata_raw);
[~,mms3_mec_r_gsedata_interp] = interpxyz(mms3_mec_timedata_raw,mms3_mec_r_gsedata_raw,mms1_fgm_timedata_raw);
[~,mms4_fgm_bdata_interp] = interpxyz(mms4_fgm_timedata_raw,mms4_fgm_bdata_raw,mms1_fgm_timedata_raw);
[~,mms4_mec_r_gsedata_interp] = interpxyz(mms4_mec_timedata_raw,mms4_mec_r_gsedata_raw,mms1_fgm_timedata_raw);


%Crop mec data to specific time period
[~,mms1_mec_r_gsedata,~,~] = crop(mms1_fgm_timedata_raw,mms1_mec_r_gsedata_interp,date_start,date_end);
[~,mms2_mec_r_gsedata,~,~] = crop(mms1_fgm_timedata_raw,mms2_mec_r_gsedata_interp,date_start,date_end);
[~,mms3_mec_r_gsedata,~,~] = crop(mms1_fgm_timedata_raw,mms3_mec_r_gsedata_interp,date_start,date_end);
[~,mms4_mec_r_gsedata,~,~] = crop(mms1_fgm_timedata_raw,mms4_mec_r_gsedata_interp,date_start,date_end);
...
[~,mms2_fgm_bdata,~,~] = crop(mms1_fgm_timedata_raw,mms2_fgm_bdata_interp,date_start,date_end);
[~,mms3_fgm_bdata,~,~] = crop(mms1_fgm_timedata_raw,mms3_fgm_bdata_interp,date_start,date_end);
[~,mms4_fgm_bdata,~,~] = crop(mms1_fgm_timedata_raw,mms4_fgm_bdata_interp,date_start,date_end);
...
n = sprintf(strcat(num2str(n_boundary(:,cc_max_component_index)','[%.4f %.4f %.4f]')))

v = sprintf(strcat(num2str(v_boundary(cc_max_component_index)','%3.1f'),'km/s'))

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Plotting%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Plot the total magnetic field for each spacecraft
plot_fgm_magnetic(date_start,date_end,mms1_fgm_timedata,mms1_fgm_bdata(:,4:4),num_plots,plot_order)
hold on
plot_fgm_magnetic(date_start,date_end,mms1_fgm_timedata,mms2_fgm_bdata(:,4:4),num_plots,plot_order)
plot_fgm_magnetic(date_start,date_end,mms1_fgm_timedata,mms3_fgm_bdata(:,4:4),num_plots,plot_order)
plot_fgm_magnetic(date_start,date_end,mms1_fgm_timedata,mms4_fgm_bdata(:,4:4),num_plots,plot_order)
hold off
ylabel({'B_T';'[nT]'},'FontSize', 14)
legend('off')
...
subplot(num_plots,1,plot_order)
plot(time_delay,[cc12(:,2),cc13(:,2),cc14(:,3)])
legend({'1-2', '1-3', '1-4'},'FontSize',14)
legend('boxoff')
legend('Location','eastoutside')
set(gca,'XTicklabel',[],'XMinorTick','on','YMinorTick','on','linewidth',1.25)
...
plot_name =  strcat('mms','_Timing_',date_start(1:19),'.pdf');
