...
event_start = '2015-12-28 05:26:50.000';
event_end = '2015-12-28 05:27:35.000';

date_start = '2015-12-28 05:27:26.500';
date_end = '2015-12-28 05:27:27.125';
...
event_start_index = find(mms1_fgm_timedata_raw > datenum(event_start,formatIn), 1)-1;
...
[MVAB_timing_angle,MVAB_timing_angle_index] = min(MVAB_timing_angle_all);


n = sprintf(strcat(num2str(n_boundary(:,MVAB_timing_angle_index)','[%.4f %.4f %.4f]')))

v = sprintf(strcat(num2str(v_boundary(MVAB_timing_angle_index)','%3.1f'),'km/s'))
