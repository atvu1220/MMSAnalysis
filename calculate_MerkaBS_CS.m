...
function [shock_normal,HFAtoBS_Distance,bs_pos,closest_shock_normal,ClosestDistance,closest_point,Intersection] = calculate_MerkaBS_CS(...
    ...
    figure
    fsurf(matlabFunction(Zmerka_bowshock(1))) %Plot the +z surface
    hold on
    fsurf(matlabFunction(Zmerka_bowshock(2))) %Plot the -z surface
    ...
    [ClosestDistance,closest_point] = calculate_closestDistance(merka_bowshock, core_position,a1,a3,a4,a7,a8);
