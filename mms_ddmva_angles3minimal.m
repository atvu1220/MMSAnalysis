...
%plot_range= [ '2018-01-09/8:34:49','2018-01-09/8:34:50.0']
...
title_name = 'MMS MDDB & MVAB Boundary Normal';
...
ylabel(strcat('MDDB_',mddl),'FontSize', 14)
...
% %xlim([datetime(tstart,'ConvertFrom','datenum') datetime(tend,'ConvertFrom','datenum')]);
% 
% ylabel(strcat('\lambda_{MDDB}'),'FontSize', 14)
% 
% 
% 
% xlim([mms1_fgm_btimedata(1) mms1_fgm_btimedata(end)])
...
ylabel(strcat('MDDB_{Error}'),'FontSize', 14)
...
set(f5,'Position',[plot_pos(1), plot_pos(2)-3*plot_pos(4)-0.100, plot_pos(3), plot_pos(4)*1]);
...
set(f6,'Position',[plot_pos(1), plot_pos(2)-4*plot_pos(4)-0.125, plot_pos(3), plot_pos(4)*1]);
...
set(f7,'XMinorTick','on','YMinorTick','on')

set(f7,'Position',[plot_pos(1), plot_pos(2)-5*plot_pos(4)-0.150, plot_pos(3), plot_pos(4)*1]);
...
annotation('textbox',[plot_pos(1)-0.055, plot_pos(2)-5*plot_pos(4)-.2, plot_pos(3), plot_pos(4)*1],...
...
annotation('textbox',[plot_pos(1), plot_pos(2)-5.5*plot_pos(4)-0.24, plot_pos(3), plot_pos(4)*1],...
    'String',strcat('(Averaged MDDB)\cdot(Centered MVAB) Angle= ', ' ', num2str(MDD_dot_MVA_center,'%2.2f'),char(176)),...
    'VerticalAlignment','Bottom','Edgecolor','none','FontSize', 14);
...
annotation('textbox',[plot_pos(1), plot_pos(2)-5.5*plot_pos(4)-0.180, plot_pos(3), plot_pos(4)*1],...
    'String',strcat('Averaged MDDB Normal = ', ' ', num2str(Mean_grad_B_MDD_normal',' [%0.4f, %0.4f, %0.4f]')),...
    'VerticalAlignment','Bottom','Edgecolor','none','FontSize', 14);
...
annotation('textbox',[plot_pos(1), plot_pos(2)-5.5*plot_pos(4)-0.21, plot_pos(3), plot_pos(4)*1],...
    'String',strcat('Centered MVAB Normal = ', ' ', num2str(MVA_min_normal,' [%0.4f, %0.4f, %0.4f]')),...
    'VerticalAlignment','Bottom','Edgecolor','none','FontSize', 14);
