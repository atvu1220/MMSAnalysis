function [MVA_n,timing_n,timing_v,MVA_timing_angle] = plot_complete_boundary_analysis(event_start,event_end,date_start,date_end,...
    ...
    if strcmp(plot_pdf,'yes')
        ...
        plot_name =  strcat('MVA_MDD_',date_start(1:23),'.pdf');
    ...
    [~,MVAB_timing_angle_index] = min(MVAB_timing_angle_all);
    ...
    if strcmp(plot_pdf,'yes')
        orient(gcf,'landscape')
        plot_name =  strcat('Timing_',date_start(1:23),'.pdf');
        print(gcf, '-dpdf',plot_name,'-fillpage');
        %movefile(plot_name, '~/Library/Mobile Documents/com~apple~CloudDocs/Research/Analysis')
    end
end
