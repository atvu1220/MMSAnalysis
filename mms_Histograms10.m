...
plot_histogram({'Height','[Re]'},0:2:8,...
    rmoutliers(get_data(type1,'Event Height'),'thresholdfactor',3),name1,...
    rmoutliers(get_data(type2,'Event Height'),'thresholdfactor',3),name2) %112
...
% % plot_histogram({'Area','[Re^2]'},0:1:2,...
...
%Age
plot_histogram({'Age','[s]'},0:30:160,...
    rmoutliers(get_data(type1b,'Age'),'thresholdfactor',3),name1,...
    rmoutliers(get_data(type2b,'Age'),'thresholdfactor',3),name2)

%Size
plot_histogram({'Size','[Re]'},0:1:3,...
    rmoutliers(get_data(type1b,'Size'),'thresholdfactor',5),name1,...
   rmoutliers(get_data(type2b,'Size'),'thresholdfactor',5),name2)
...
%%
plot_histogram({'Substructure Density Ratio','[#]'},-0.25:0.5:4.5,...
...
plot_histogram({'Substructure Vx Ratio','[#]'},0:0.2:2,...
    rmoutliers(get_data(type1,'SSCoreVxRatio'),'thresholdfactor',3),'Core',...
    (get_data(type1,'SSSWVxRatio')),'SW')
% histogram(get_data(type1,'SSCoreVxRatio'),VxBins)
% hold on
% histogram(get_data(type1,'SSSWVxRatio'),VxBins)

plot_histogram({'Substructure Dynamic Pressure Ratio','[#]'},-0.25:0.5:3,...
...
plot_histogram({'Substructure Duration','[s]'},0.0:0.5:5,...
    rmoutliers(get_data(type1,'SS Duration'),'thresholdfactor',5),'Substructured Events',[],'')
