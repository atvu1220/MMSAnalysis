...
% probe = 3;
slices_directory = strcat('~/Library/Mobile Documents/com~apple~CloudDocs/Research/Analysis/Velocity Distributions/' ,'EE',num2str(EE_EventNumber),'/',num2str(probe),Rotation);
