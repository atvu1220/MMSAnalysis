...
%datenum format
start_event = find(mms1_fgm_btimedata_raw > tstart, 1)-1;
end_event = find(mms1_fgm_btimedata_raw > tend, 1);

%Crop data to specified time range
mms1_fgm_btimedata = mms1_fgm_btimedata_raw(start_event:end_event);

mms1_fgm_bdata_interp = mms1_fgm_bdata_raw(start_event:end_event,1:3);
mms2_fgm_bdata_interp = mms2_fgm_bdata_interp(start_event:end_event,:);
mms3_fgm_bdata_interp = mms3_fgm_bdata_interp(start_event:end_event,:);
mms4_fgm_bdata_interp = mms4_fgm_bdata_interp(start_event:end_event,:);

mms1_fgm_rdata_interp = mms1_fgm_rdata_interp(start_event:end_event,1:3);
mms2_fgm_rdata_interp = mms2_fgm_rdata_interp(start_event:end_event,:);
mms3_fgm_rdata_interp = mms3_fgm_rdata_interp(start_event:end_event,:);
mms4_fgm_rdata_interp = mms4_fgm_rdata_interp(start_event:end_event,:);
...
plot(mms1_fgm_btimedata,mms1_fgm_bdata_raw(start_event:end_event,1:4))
%plot(fgm_timedata(start_event:end_event,:),bdata(start_event:end_event,1:4))
% mid = start_event+round(length(fgm_timedata(start_event:end_event))/2);
%
%
...
title_name = 'MMS Directional Derivative, Eigenvalues and Normals';
title(title_name, 'FontSize', 18, 'FontWeight', 'normal')
xlim([mms1_fgm_btimedata(1) mms1_fgm_btimedata(end)])


set(f1,'XMinorTick','on','YMinorTick','on','XTickLabel',[])
...
%plot(mms1_fgm_btimedata,smoothdata(squeeze(eig_vectors(1,1,:)),'movmean',4))
% plot(mms1_fgm_btimedata,(squeeze(eig_vectors(1,1,:))))
% hold on
% plot(mms1_fgm_btimedata,(squeeze(eig_vectors(2,1,:))))
%plot(mms1_fgm_btimedata,(squeeze(eig_vectors(3,1,:))))
% plot(mms1_fgm_btimedata,squeeze(eig_lambda(3,3,:)))
% hold on
% plot(mms1_fgm_btimedata,squeeze(eig_lambda(2,2,:)))
% plot(mms1_fgm_btimedata,squeeze(eig_lambda(1,1,:)))
%
plot(mms1_fgm_btimedata,squeeze(sqrt(eig_lambda(3,3,:))))
hold on
plot(mms1_fgm_btimedata,squeeze(sqrt(eig_lambda(2,2,:))))
plot(mms1_fgm_btimedata,squeeze(sqrt(eig_lambda(1,1,:))))
hold off

%plot(mms1_fgm_btimedata,squeeze(eig_lambda(3,3,:))./squeeze(eig_lambda(1,2,:)))
% plot(mms1_fgm_btimedata,squeeze(eig_lambda(2,2,:)))
% plot(mms1_fgm_btimedata,squeeze(eig_lambda(1,1,:)))
%plot(mms1_fgm_btimedata,squeeze(eig_lambda(2,2,:)./eig_lambda(1,1,:)))
% hold on
% plot(mms1_fgm_btimedata,dd_vmax(:,2)')
% plot(mms1_fgm_btimedata,dd_vmax(:,3)')
% hold off
box on
datetick
set(gca,'layer','top')
%legend({'L_{max}', 'L_{mid}', 'L_{min}'},'FontSize',14)
...
set(l1(2),'Position',[plot_pos(1)+plot_pos(3)+0.05, plot_pos(2)+1*plot_pos(4), l1pos(3), l1pos(4)]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
set(l1(3),'Position',[plot_pos(1)+plot_pos(3)+0.075, plot_pos(2)+2*plot_pos(4), l1pos(3), l1pos(4)]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% plot(mms1_fgm_btimedata,(squeeze(eig_vectors(2,1,:))))
%plot(mms1_fgm_btimedata,(squeeze(eig_vectors(3,1,:))))
plot(mms1_fgm_btimedata,squeeze(eig_vectors(1,2,:)))
hold on
plot(mms1_fgm_btimedata,squeeze(eig_vectors(2,2,:)))
plot(mms1_fgm_btimedata,squeeze(eig_vectors(3,2,:)))
hold off
% plot(mms1_fgm_btimedata,squeeze(eig_lambda(2,2,:)))
% plot(mms1_fgm_btimedata,squeeze(eig_lambda(1,1,:)))
%plot(mms1_fgm_btimedata,squeeze(eig_lambda(2,2,:)./eig_lambda(1,1,:)))
...
plot(mms1_fgm_btimedata,smooth(squeeze(eig_vectors(1,1,:))))
hold on
plot(mms1_fgm_btimedata,smooth(squeeze(eig_vectors(2,1,:))))
plot(mms1_fgm_btimedata,smooth(squeeze(eig_vectors(3,1,:))))
hold off
% plot(mms1_fgm_btimedata,squeeze(eig_lambda(2,2,:)))
% plot(mms1_fgm_btimedata,squeeze(eig_lambda(1,1,:)))
%plot(mms1_fgm_btimedata,squeeze(eig_lambda(2,2,:)./eig_lambda(1,1,:)))
...
Ax = abs(squeeze(eig_vectors(1,3,:)));
Ay = abs(squeeze(eig_vectors(2,3,:)));
Az = abs(squeeze(eig_vectors(3,3,:)));
